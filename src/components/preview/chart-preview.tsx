          ...
          >
            {config.title.show && (config.title.text || config.title.subtitle) && (
              <div className="shrink-0" style={{ textAlign: config.title.align, paddingBottom: 8 }}>
                {config.title.text && (
                  <div style={{ fontSize: config.title.fontSize, color: config.title.fontColor, fontWeight: config.title.fontWeight, lineHeight: config.title.lineHeight }}>
                    {config.title.text}
                  </div>
                )}
                {config.title.subtitle && (
                  <div style={{ fontSize: config.title.subtitleFontSize, color: config.title.subtitleFontColor, fontWeight: config.title.subtitleFontWeight, lineHeight: config.title.subtitleLineHeight, marginTop: 2 }}>
                    {config.title.subtitle}
                  </div>
                )}
              </div>
